            ...
            $response_array = ['success' => false, 'error_messages' => $errors , 'error_messages' => $errors,'error_code' => 101];
                ...
                foreach ($model as $key => $value) {
                    ...
                    if($videopayment) {
                        ...
                        $url = ($value->amount > 0 && $videopayment->status == DEFAULT_FALSE) ? route('user.payment_url', array('id'=>$value->video_id, 'user_id'=> $request->id)): route('user.live_video.start_broadcasting', array('id'=>$value->unique_id,'c_id'=>$value->channel_id));
                    }
