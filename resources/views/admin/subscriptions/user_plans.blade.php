									    ...
									    <tr>
									      	...
									      	<td class="text-center">
									      		...
									      		@elseif($i == 0 && $payment->is_cancelled && $payment->status == PAID_STATUS)
								      				...
								      				<a onclick="return confirm('{{$enable_subscription_notes}}')" href="{{route('admin.enable.subscription', ['id'=>$payment->id])}}" class="pull-right btn btn-sm btn-success">{{tr('enable_subscription')}}</a>
