                ...
                <form class="form-horizontal" action="{{route('admin.subscriptions.save')}}" method="POST" enctype="multipart/form-data" role="form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" min="1" max="12" pattern="[0-9][0-2]{2}"  name="plan" class="form-control" id="plan" value="{{isset($data) ? $data->plan : old('plan')}}" title="{{tr('month_of_plans')}}" placeholder="{{tr('plans')}}">
                        </div>
