        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box-header label-primary">
                    <b style="font-size:18px;">{{tr('add_banner_videos')}}</b>
                    <a href="{{route('admin.banner.videos')}}" class="btn btn-default pull-right">{{tr('videos')}}</a>
                </div>
                        ...
                        <div class="col-md-5">
                            ...
                            <div id="upload" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" accept="video/mp4" name="video" placeholder="{{tr('picture')}}">
                                    <p class="help-block">{{tr('video_validate')}}</p>
                                </div>

                                <div class="form-group">
                                    <label for="trailer_video" class="">{{tr('trailer_video')}}</label>
                                    <input type="file" id="trailer_video" name="trailer_video" accept="video/mp4" placeholder="{{tr('trailer_video')}}">
                                    <p class="help-block">{{tr('video_validate')}}</p>
                                </div>
