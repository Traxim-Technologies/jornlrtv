                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" required id="default_image" accept="image/x-png,image/gif,image/jpeg" name="default_image" placeholder="{{tr('default_image')}}">
                                <p class="help-block">{{tr('image_validate')}}</p>
                            </div>

                            <div class="form-group">
                                <label for="other_image1" class="">{{tr('other_image1')}}</label>
                                <input type="file" required id="other_image1" accept="image/x-png,image/gif,image/jpeg" name="other_image1" placeholder="{{tr('other_image1')}}">
                                <p class="help-block">{{tr('image_validate')}}</p>
                            </div>

                            <div class="form-group">
                                <label for="other_image2" class="">{{tr('other_image2')}}</label>
                                <input type="file" required id="other_image2" accept="image/x-png,image/gif,image/jpeg" name="other_image2" placeholder="{{tr('other_image2')}}">
                                <p class="help-block">{{tr('image_validate')}}</p>
                            </div>
