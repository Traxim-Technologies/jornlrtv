                                    ...
                                    <tr>
                                        ...
                                        <td width="400" align="center" style="padding-bottom:5px;">
                                            <div class="contentEditableContainer contentTextEditable">
                                                <div class="contentEditable" >
                                                    <p>
                                                    	"You recently requested to reset password for your {{Setting::get('site_name' , 'Start Streaming')}} account. Click the reset button to reset password."
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" border="0" align="center" width="200" height="50">
                                                <tr>
                                                    ...
                                                    <td bgcolor="#109610" align="center" style="border-radius:4px;text-decoration: none" width="200" height="50">
                                                        <div class="contentEditableContainer contentTextEditable">
                                                            <div class="contentEditable" >
                                                                <a href="{{ $link = url('/admin/password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}" style="color: #FFF;text-orientation: none" class='link2'>Reset Now</a>
                                                            </div>
                                                        </div>
