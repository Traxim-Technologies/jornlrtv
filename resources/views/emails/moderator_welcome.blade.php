                              ...
                              <tbody>
                                <tr>
                                  <td class="mcnButtonContent" style="font-family: &quot;Helvetica Neue&quot;,Helvetica,Arial,Verdana,sans-serif; font-size: 14px; padding: 15px;" valign="middle" align="center">
                                        ...
                                        <p style="color: #fff">Your Email :  @if(isset($email_data)) {{$email_data['email']}}@endif </p>

                                        <p style="color: #fff">Your Password : @if(isset($email_data)){{$email_data['password']}} @endif</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table></td>
