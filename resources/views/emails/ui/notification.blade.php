...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  ...
  */
  ...
  /*
  #tab Page
  #section lower body background style
  #tip Set the background color for the lower portion of your email.
  */
    #lowerBody{
      /*#editable*/background-color:#f97676;
    }
  /*
  #tab Page
  #section heading 1
  ...
  */
    #templatePreheader{
      /*#editable*/background-color:#C8BA8C;
      /*#editable*/border-top:0;
  ...
  */
    #templateFooter{
      /*#tab Footer
#section footer style
#tip Set the background color and borders for your email's footer area.*/background-color:#FFFFFF;
      /*#editable*/border-top:0;
    }
    .footerContainer{
      padding-bottom:40px;
                    ...
                    <table class="mcnImageContentContainer" style="min-width:100%;" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                        <tbody><tr>
                            <td class="mcnImageContent" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top">
                                        ...
                                        <img alt="" src="https://gallery.mailchimp.com/56e7d21923a490b7f86615d02/images/eed35daf-4a76-47f8-a2ce-cb7422581a73.png" style="max-width:100%;width: auto;height: 45px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage" width="429" align="middle">
                ...
                <table style="max-width:100%; min-width:100%;" class="mcnTextContentContainer" width="100%" cellspacing="0" cellpadding="0" border="0" align="left">
                    <tbody><tr>
                        ...
                        <td class="mcnTextContent" style="padding: 0px 18px 9px;color: #000000;font-style: normal;font-weight: normal;" valign="top">
                            ...
                            This Christmas season, Chuck is unveiling four new trees, and the first folks to get a crack at these festive firs are Chuck Talk subscribers like you!<br>
&nbsp;
                        </td>
                    </tr>
                </tbody></table>
    ...
    <tbody class="mcnButtonBlockOuter">
        <tr>
            <td style="padding-top:20px; padding-right:18px; padding-bottom:18px; padding-left:18px;" class="mcnButtonBlockInner" valign="top" align="center">
                    ...
                    <tbody>
                        <tr>
                            <td class="mcnButtonContent" style="font-family: Arial; font-size: 16px; padding:10px 25px;" valign="middle" align="center">
                                <a class="mcnButton " title="Visit Now" href="http://" target="_blank" style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Visit Now</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
