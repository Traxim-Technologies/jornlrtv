    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{(Setting::get('admin_delete_control') == 1) ? '' : route('moderator.save.edit.video')}}" method="POST" enctype="multipart/form-data" role="form">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="default_image" name="default_image" accept="image/png, image/jpeg" placeholder="{{tr('default_image')}}">
                            ...
                            @if($video->is_banner)
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" id="banner_image" name="banner_image" accept="image/png, image/jpeg" placeholder="{{tr('banner_image')}}">
                                    <p class="help-block">{{tr('image_validate')}}</p>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" id="other_image1" name="other_image1" accept="image/png, image/jpeg" placeholder="{{tr('other_image1')}}">
                                <p class="help-block">{{tr('image_validate')}}</p>
                            </div>

                            <div class="form-group">
                                <label for="other_image2" class="">{{tr('other_image2')}}</label>
                                <input type="file" id="other_image2" name="other_image2" accept="image/png, image/jpeg" placeholder="{{tr('other_image2')}}">
                                <p class="help-block">{{tr('image_validate')}}</p>
                            </div>
