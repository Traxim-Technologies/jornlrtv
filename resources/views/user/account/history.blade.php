        ...
        <div class="history-content page-inner col-sm-9 col-md-10">
            ...
            <div class="new-history">
                <div class="content-head">
                    <div><h4 class="no-margin-top">{{tr('history')}}</h4></div>
                            ...
                            <li class="sub-list row">
                                <div class="main-history">
                                    ...
                                    <div class="history-title">
                                        ...
                                        <span class="stars">
                                           <a><i @if($history->ratings >= 1) style="color:gold" @endif class="fa fa-star" aria-hidden="true"></i></a>
                                           <a><i @if($history->ratings >= 2) style="color:gold" @endif class="fa fa-star" aria-hidden="true"></i></a>
                                           <a><i @if($history->ratings >= 3) style="color:gold" @endif class="fa fa-star" aria-hidden="true"></i></a>
                                           <a><i @if($history->ratings >= 4) style="color:gold" @endif class="fa fa-star" aria-hidden="true"></i></a>
                                           <a><i @if($history->ratings >= 5) style="color:gold" @endif class="fa fa-star" aria-hidden="true"></i></a>
                                        </span>      
