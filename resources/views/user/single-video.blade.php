                            ...
                            <div class="author-des clearfix">
                                <div class="post-title">
                                    ...
                                    <p>
                                        ...
                                        <span>
                                            <i id="watch_count" class="fa fa-eye">{{$video->watch_count}}</i>
                                        ...
                                        <span>
                                            <i id="video_comment_count" class="fa fa-commenting">{{get_video_comment_count($video->admin_video_id)}}</i>
