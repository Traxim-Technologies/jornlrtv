...
@if(isset($tag)) <span class="text-green"> {{ $tag->name }} </span> - @endif {{ tr('videos') }}
							...
							<tbody>
								...
								@foreach($videos as $i => $video)
								    ...
								    <tr>
								      	...
								      	<td><a href="{{ route('admin.video_tapes.view' , array('video_tape_id' => $video->video_tape_id)) }}">{{ $i+1 }}</a></td>								      	
								      	...
								      	<td><a href="{{ route('admin.video_tapes.view' , array('video_tape_id' => $video->video_tape_id)) }}"> {{ substr($video->title , 0,25) }}...</a></td>
	            							...
	            							<ul class="admin-action btn btn-default">
	            								<li class="dropup">
									                ...
									                <ul class="dropdown-menu">
	                                                    ...
	                                                    @endif
									                  	<li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="{{ route('admin.video_tapes.view' , array('video_tape_id' => $video->video_tape_id)) }}">{{ tr('view') }}</a></li>
