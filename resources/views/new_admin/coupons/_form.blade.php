<form action="{{ Setting::get('admin_delete_control') == YES ? '#'  : route('admin.coupons.save')}}" method="POST" class="form-horizontal" role="form">
	...
	<div class="box-body">
		...
		<div class="form-group">
			<div class="col-sm-6">
				<label for="amount" control-label"> * {{ tr('per_users_limit') }}</label>
			...
			<div class="col-sm-6">
				<label for="no_of_users_limit" control-label"> * {{ tr('no_of_users_limit') }}</label>
		...
		<div class="form-group">
			<div class="col-sm-6">
				<label for="expiry_date" control-label"> * {{ tr('expiry_date') }}</label>
			...
			<div class="col-sm-6">
				<label for="description" control-label">{{ tr('description') }} </label>
