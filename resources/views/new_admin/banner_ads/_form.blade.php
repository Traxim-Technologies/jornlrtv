...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        <div class="box box-primary">
            ...
            <form  action="{{ Setting::get('admin_delete_control') == YES ? '#' : route('admin.banner-ads.save') }}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="box-body">
                   ...
                   <!--  <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="title" id="position" placeholder="{{ tr('position') }}" value="{{ $banner_ad_details->position }}">
                    </div> -->
                    
                    <div class="form-group">
                        <label for="title">{{ tr('title') }}</label>
                        <input type="text" class="form-control" name="title" id="title" placeholder="{{ tr('enter_title') }}" value="{{ $banner_ad_details->title }}">
                    </div>
