    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <form  action="{{ route('admin.video_ads.save') }}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <input type="hidden" name="video_tape_id" id="video_tape_id" value="{{ $video_tape_details->id }}">
                ...
                <div class="box-body">
                	...
                	<div class="col-md-6">
	                    @if($video_tape_details->video)
	                        <?php $url = $video_tape_details->video; ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item">
                                <b><i class="fa fa-clock-o margin-r-5"></i>{{ tr('duration') }}</b> <div class="pull-right">{{ $video_tape_details->duration }}</div>
                            </li>

                            <li class="list-group-item">
                                <b><i class="fa fa-clock-o margin-r-5"></i>{{ tr('duration_in_seconds') }}</b> 
                                <div class="pull-right">{{ $duration_in_seconds = convertDurationIntoSeconds($video_tape_details->duration) }}</div>
                            </li>
                        </ul>
            ...
            @if($url)
                ...
                var playerInstance = jwplayer("main-video-player");
                    ...
                    playerInstance.setup({
                        sources: path,
                        image: "{{ $video_tape_details->default_image }}",
                        width: "100%",
...
function addQuestion(index) {
    ...
    $.ajax({
        type : "post",
        url : "{{ route('admin.video_ads.inter-ads') }}",
        data : {index:index},
