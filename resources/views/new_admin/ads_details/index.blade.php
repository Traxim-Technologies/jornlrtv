							...
							<tbody>
								...
								@foreach($ads_details as $i => $ads_detail_detail)
								    ...
								    <tr>
								      	...
								      	<td>{{ $ads_detail_detail->ad_time }}</td>
	            								...
	            								<li class="dropup">
									                ...
									                <ul class="dropdown-menu">
									                  	...
									                  	<li role="presentation">
	                                                        ...
	                                                        @else
	                                                            <a role="menuitem" tabindex="-1" href="{{ route('admin.ads-details.edit' , ['ads_detail_id' => $ads_detail_detail->id] ) }}">{{ tr('edit') }}</a>
	                                                        @endif
	                                                    </li>
	                                                    
									                  	<li role="presentation"><a role="menuitem" tabindex="-1" href="{{ route('admin.ads-details.view' , ['ads_detail_id' => $ads_detail_detail->id] ) }}">{{ tr('view') }}</a></li>
									            ...
									            <div class="modal-body">
									            	...
									            	<div class="row">
										            	...
										            	<div class="col-lg-12">
										            		...
										            		<input type="hidden" name="id" value="{{ $ads_detail_detail->id }}">
